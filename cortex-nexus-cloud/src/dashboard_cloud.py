...
DATA_PATH = "data/cycles_cloud.jsonl"
...
st.title("🛰️ Cortex-Nexus Cloud v1.0")
st.markdown("### Monitor de Investigación Autónoma (OpenRouter Pure)")
st.markdown("---")
...
if df.empty:
    ...
    # Load curiosity init from config
    with open(CONFIG_PATH) as f:
        conf = json.load(f)
    curiosity_init = conf['curiosity']['initial_value']
